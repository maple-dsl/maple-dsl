...
public class CypherFetchTest extends CypherBaseTest {
    ...
    public void should_fetch_vertex_return_itself_automatic(String expected) {
        assertEquals(expected, vertex(Person.class, 1001L).render());
        assertEquals(expected, vertex("person", 1001L).render());
    }
    ...
    public void should_fetch_vertices_text_id_return_itself_automatic(String expected) {
        assertEquals(expected, vertex(Person.class, 1001L, 1002L).render());
        assertEquals(expected, vertex("person", 1001L, 1002L).render());
        assertEquals(expected, vertex("person", ImmutableList.of(1001L, 1002L)).render());
    }
    ...
    public void should_fetch_vertices_numeric_id_return_itself_automatic(String expected) {
        assertEquals(expected, vertex(Person.class, 1L, 2L, 3L).render());
        assertEquals(expected, vertex("person", 1L, 2L, 3L).render());
    ...
    public void should_fetch_edge_return_itself_automatic(String expected) {
        assertEquals(expected, edge(Impact.class, 1001L).render());
        assertEquals(expected, edge("impact", 1001L).render());
    }
    ...
    public void should_fetch_edges_string_vid_return_itself_automatic(String expected) {
        assertEquals(expected, edge(Impact.class, 1001L, 1002L, 1003L).render());
        assertEquals(expected, edge("impact", 1001L, 1002L, 1003L).render());
        assertEquals(expected, edge("impact", Arrays.asList(1001L, 1002L, 1003L)).render());
        assertEquals(expected, edge("impact", ImmutableList.of(1001L, 1002L, 1003L)).render());
    }
    ...
    public void should_fetch_edge_with_selection_ordering(String expected) {
        assertEquals(expected, edge(Impact.class,1001L,1002L,1003L)
