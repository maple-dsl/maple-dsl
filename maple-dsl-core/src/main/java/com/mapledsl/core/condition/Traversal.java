...
/**
 * The Traversal interface represents a set of methods to specify traversal conditions for searching outgoing, incoming,
 * and bidirectional edges. It provides methods to specify the step numbers, edge types, and vertex aliases for the traversal.
 */
